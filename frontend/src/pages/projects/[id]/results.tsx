  ...
  return (
    <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
      <div className="flex items-center gap-2 mb-1">
        {Icon ? <Icon className={`text-${color}-600`} /> : null}
              ...
              <div className="card p-5 mb-4">
                ...
                <div className="h-72">
                  <Line data={cashflowChart} options={{
                    responsive: true, maintainAspectRatio: false,
                    scales: { y: { ticks: { callback: (v: string | number) => `${currSym}${(Number(v) / 1000000).toFixed(1)}M` } } },
                    plugins: { legend: { position: 'bottom' } },
                  }} />
                </div>
              </div>
              ...
              {result?.energy_comparison?.yearly_comparison?.length > 0 && (
                <div className="card p-5">
                  ...
                  <div className="h-72">
                    ...
                    }} options={{ responsive: true, maintainAspectRatio: false, plugins: { legend: { position: 'top' } }, scales: { y: { beginAtZero: true, ticks: { callback: (v: string | number) => `${currSym}${(Number(v) / 1000000).toFixed(1)}M` } } } }} />
                  </div>
