...
export default function VerificationSettings() {
  const { profile, verificationStatus, isVerified, refreshProfile } = useAuth();
                  ...
                  {isRejected && profile?.verification_rejection_reason && (
                    <div className="mt-3 p-3 bg-white rounded-lg border border-red-200">
                      ...
                      <p className="text-sm text-red-800">
                        {String(profile.verification_rejection_reason ?? '')}
                      </p>
                      <button
                        onClick={() => {
                  ...
                  {isPending && (
                    <div className="mt-3 flex items-center gap-2 text-xs text-amber-700">
                      ...
                      {profile?.verification_requested_at
                        ? new Date(String(profile.verification_requested_at)).toLocaleDateString()
                        : 'Recently'}
                    </div>
                  )}
                </div>
                ...
                {profile?.verified_at && (
                  <div className="mt-4 pt-4 border-t border-green-200">
                    <p className="text-xs text-green-700">
                      ...
                      {new Date(String(profile.verified_at)).toLocaleDateString('en-NG', {
