  ...
  return (
    <>
      ...
      <div className="max-w-lg mx-auto py-16 px-4 text-center">
        ...
        <h1 className="font-display font-bold text-2xl text-slate-800 mb-3">
          Paystack Payments Unavailable
        </h1>
        <p className="text-slate-500 text-sm leading-relaxed mb-8">
          Online card and USSD payment via Paystack is not yet available on SolNuv.
          <br className="hidden sm:block" />
          Please use <strong className="text-slate-700">Direct Bank Transfer</strong> to activate your plan,
