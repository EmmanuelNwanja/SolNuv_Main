    ...
    <AdminRoute>
      ...
      {activeTab === 'overview' && overview && (
        <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4">
          <div className="card"><p className="text-xs text-slate-500">Users</p><p className="text-2xl font-bold text-forest-900">{overview.users}</p></div>
          <div className="card"><p className="text-xs text-slate-500">Companies</p><p className="text-2xl font-bold text-forest-900">{overview.companies}</p></div>
          <div className="card"><p className="text-xs text-slate-500">Projects</p><p className="text-2xl font-bold text-forest-900">{overview.projects}</p></div>
          <div className="card"><p className="text-xs text-slate-500">Active Subscriptions</p><p className="text-2xl font-bold text-emerald-700">{overview.active_subscriptions}</p></div>
          <div className="card"><p className="text-xs text-slate-500">Revenue (30d)</p><p className="text-2xl font-bold text-forest-900">N{Number(overview.revenue_30d_ngn || 0).toLocaleString('en-NG')}</p></div>
          <div className="card"><p className="text-xs text-slate-500">Queued Push Notifications</p><p className="text-2xl font-bold text-amber-700">{overview.queued_push_notifications}</p></div>
        </div>
      )}
