                              ...
                              try {
                                ...
                                if (mgmtPlan !== 'free' && mgmtPlan !== (u.companies?.subscription_plan || 'free')) {
                                  ...
                                  if (mgmtPayChannel === 'direct_transfer') {
                                    ...
                                    payload.bank_confirmed_at =
                                      mgmtBankDate && mgmtBankTime
                                        ? new Date(`${mgmtBankDate}T${mgmtBankTime}`).toISOString()
                                        : undefined;
                                  }
                                  if (mgmtCouponCode) {
                    ...
                    <div className="pt-2 flex gap-3">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            const notes = (document.getElementById(`notes-${req.id}`) as HTMLInputElement | null)?.value;
