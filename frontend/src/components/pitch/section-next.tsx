      ...
      <div className="flex flex-col min-h-[100svh] justify-center container">
        <div className="grid md:grid-cols-3 gap-4 md:gap-8 px-4 md:px-0 pt-20 md:pt-0 pb-28 md:pb-0">
          <div className="space-y-8">
            <Card className="min-h-[250px] sm:min-h-[320px] md:min-h-[370px]">
          ...
          <div className="ml-auto w-full border border-border p-4 md:p-6 bg-[#0C0C0C]">
            <h2 className="mb-8 md:mb-24 block text-xl">Native app</h2>
            <span />
