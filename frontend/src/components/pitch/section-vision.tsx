...
export function SectionVision() {
  return (
    <div className="min-h-[100svh] md:h-[100svh] md:overflow-hidden relative w-full">
      ...
      <div className="flex flex-col min-h-[100svh] md:h-[100svh] justify-center container pt-20 md:pt-0 pb-28 md:pb-0">
        <h1 className="text-[clamp(2rem,8.6vw,6.2rem)] px-4 md:px-0 font-medium text-center leading-none">
