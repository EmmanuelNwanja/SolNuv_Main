...
function CalculationTemplate({
  ...
  const label = (type && CALCULATOR_LABELS[type]) || "Calculation";
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">
                {daysUntilExpiry !== null ? `${daysUntilExpiry} days` : formatDate(expiresAt)}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-xs text-amber-800 leading-relaxed">
            ...
            Actual results may vary based on site conditions, equipment specifications, and installation
            quality. A detailed engineering study by a qualified professional is recommended.
          </p>
        </div>
      </div>
    </div>
