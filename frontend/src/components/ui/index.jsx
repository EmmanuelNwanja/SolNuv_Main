// StatCard.jsx
export function StatCard({ label, value, sub, icon: Icon, color = 'forest', trend }) {
  const colors = {
...
// SelectInput
export function SelectInput({ label, options, value, onChange, name, required }) {
  return (
    <div>
...
export function UrgencyBadge({ daysUntil }) {
