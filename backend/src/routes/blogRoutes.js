...
router.post('/ads/:id/impression', optionalAuth, blogController.trackAdImpression);
router.post('/ads/:id/click', optionalAuth, blogController.trackAdClick);
...
router.get('/admin/ads/analytics', requireAuth, requireAdmin, requireAdminRole('super_admin', 'operations', 'analytics'), blogController.adminListAdsAnalytics);
